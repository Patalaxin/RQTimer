...
export type OrtosHistoryDocument = HydratedDocument<OrtosHistory>;

@Schema({
  autoIndex: true,
})
export class OrtosHistory {
  @Expose()
  @Prop({
    type: String,
  ...
  constructor(partial: Partial<OrtosHistory>) {
    Object.assign(this, partial);
  }
}

export const OrtosHistorySchema = SchemaFactory.createForClass(OrtosHistory);
