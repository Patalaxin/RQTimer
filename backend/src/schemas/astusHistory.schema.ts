...
export type AstusHistoryDocument = HydratedDocument<AstusHistory>;

@Schema({
  autoIndex: true,
})
export class AstusHistory {
  @Expose()
  @Prop({
    type: String,
  ...
  constructor(partial: Partial<AstusHistory>) {
    Object.assign(this, partial);
  }
}

export const AstusHistorySchema = SchemaFactory.createForClass(AstusHistory);
